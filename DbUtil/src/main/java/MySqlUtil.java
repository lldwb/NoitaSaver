...
public class MySqlUtil {
    //数据库连接参数
    //数据库地址
    private static final String URL = "jdbc:mysql://mysql.lldwb.top:33366/tvoluntee?serverTimezone=Asia/Shanghai";
    //账号
    private static final String USER_NAME = "TVoluntee";
    //密码
    private static final String PASSWORD = "LnXjyxrSWKGf8Bjh";
